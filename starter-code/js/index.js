...
window.addEventListener('load', event => {
  ...
  document.querySelectorAll('.card').forEach(card => {
    card.addEventListener('click', () => {
      ...
      if (cardsPicked.length == 2) {
        if (!memoryGame.checkIfPair(cardsPicked[0].getAttribute("data-card-name"), cardsPicked[1].getAttribute("data-card-name"))) {
          setTimeout(() => {
        ...
        console.log(document.getElementById("pairs-guessed"))
  ...
  memoryGame.isFinished() && window.alert("You won!!!")
